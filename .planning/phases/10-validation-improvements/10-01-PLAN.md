...
export class FieldValidator {
   ...
   * @param sessionId For retry tracking
   */
  validate(field: string, value: unknown, sessionId: string): FieldValidationResult
...
**Validation flow:**
1. Get or create context for `{sessionId}:{field}`
...
4. On success: reset context, return normalized value
5. On failure: increment retry count, format German error, check for near-miss
