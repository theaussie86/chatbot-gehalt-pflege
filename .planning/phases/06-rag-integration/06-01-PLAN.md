...
must_haves:
  ...
  artifacts:
    ...
    - path: "apps/api/migrations/20260125000000_match_documents_with_metadata.sql"
...
<task type="auto">
  ...
  <files>apps/api/migrations/20260125000000_match_documents_with_metadata.sql</files>
  <action>
...
IMPORTANT: Do NOT modify the existing match_documents function. Create a NEW function alongside it.
  ...
  <verify>
File exists at apps/api/migrations/20260125000000_match_documents_with_metadata.sql with correct CREATE OR REPLACE FUNCTION syntax.
...
<success_criteria>
- [ ] Migration file apps/api/migrations/20260125000000_match_documents_with_metadata.sql created
