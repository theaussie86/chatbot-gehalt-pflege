...
- Keep the vectorstore initialization (already exists around line 140-143)
...
Grep for "Quelle" in chat/route.ts (citation formatting)
  ...
  <done>
Chat route uses queryWithMetadata() for question handling and includes citation formatting with source filenames in responses.
  </done>
</task>
...
1. **Apply migration (required for new RPC function):**
   - Run in Supabase SQL Editor: contents of `supabase/migrations/20260125000000_match_documents_with_metadata.sql`
